...
export JAVA_HOME=${JAVA_HOME:-/usr/lib/jvm/java-1.8.0-openjdk-1.8.0.151-1.b12.el7_4.x86_64/jre}
...
export HADOOP_OPTS="${HADOOP_OPTS} -Dmachine-hostname=$HOSTNAME"
case ${HOSTNAME} in
  *master1)
    export HADOOP_OPTS="${HADOOP_OPTS} -Dnamenode-id=nn1"
  ;;
  *master2)
    export HADOOP_OPTS="${HADOOP_OPTS} -Dnamenode-id=nn2"
  ;;
esac
...
# export HADOOP_OPTIONAL_TOOLS="hadoop-aws,hadoop-azure,hadoop-kafka,hadoop-openstack"
